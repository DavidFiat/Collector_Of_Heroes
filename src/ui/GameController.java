...
public class GameController {
	...
	void fight(ActionEvent event) {
		...
		if (victories > 4) {
			winAlert();
		} else if (Integer.parseInt(totalEnergy.getText()) < 0 && defeats > 4) {
			lostAlert();
		}
	...
	public void winAlert() {
		Alert alert = new Alert(AlertType.INFORMATION);
		alert.setHeaderText("VICTORY");
		alert.setContentText("You have win the game." + "\n" + "You are a great collector");
		alert.show();
